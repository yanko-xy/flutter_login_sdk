...
import 'package:login_sdk/widgets/login_button_widget.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  _jumpRegistration() async {
    // 跳转到接口后台注册账号
    Uri uri =
        Uri.parse("https://api.devio.org/uapi/swagger-ui.html#/Account/registrationUsingPost");
    if (!await launchUrl(uri, mode: LaunchMode.externalApplication)) {
      debugPrint("Cound not launch $uri");
    }
  }
